    ...
    <div class="container">
      <div class="row footer-top">
        <div class="col-sm-5 col-lg-5">
          ...
          <div class="text-md">
            <a :key="item.id" v-for="item in contacts" v-title="item.title" :href="item.link" :style="contactStyle" target="_blank">
          ...
          <div class="row">
            <div class="col-sm-4">
              ...
              <ul class="list-unstyled">
                <li :key="item.id" v-for="item in sponsor.list">
            ...
            <div class="col-sm-4">
              ...
              <ul class="list-unstyled">
                <li :key="item.id" v-for="item in statistics.list">{{ item.title }}: {{ item.description }}</li>
              </ul>
            </div>
            ...
            <div class="col-sm-4">
              ...
              <ul class="list-unstyled">
                <li :key="item.id" v-for="item in other.list">
